    ...
    return (
        ...
        <div className="mt-2 grid gap-2 grid-cols-3 md:grid-cols-4 lg:grid-cols-6">
            {addedPhotos.length > 0 && addedPhotos.map(link => {
                ...
                .replace(/^\/?uploads[\\/]+/, '') // remove leading /uploads/ or \uploads\
                .replace(/^uploads[\\/]+/, '')    // just in case it's still there
                .replace(/\\/g, '');              // remove any backslashes inside
                ...
                return (
                    <div key={link} className="relative">
                        <img
                        className="rounded-2xl w-full h-32 object-contain bg-gray-100"
                        src={finalUrl}
                        alt=""
                        />
